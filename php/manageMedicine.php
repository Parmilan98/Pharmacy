...
<html lang="en">
  ...
  <div class="sidebar close">
    ...
    <section class="home-section">
      ...
      <div class="p-2">
      <main class="px-3">
          <h3 class="text-center py-3">Manage Medicine Details</h3>
          <a href="addMedicine.php"> <button class="btn btn-primary my-2 float-end">+&nbsp;Add New Medicine</button></a>
          <?php
            ...
            if($result->num_rows>0)
            {
              echo "<table class='table table-striped table-hover'>
                      ...
                      { 
                        ...
                        echo "<td><a href='updateMedicine.php?id={$row["MID"]}' class='p-1'>
                                      <i class='fa-regular fa-pen-to-square'></i>
                                  </a>
                                  <a href='deleteMedicine.php?id={$row["MID"]}' style='color: red;' class='p-1'>

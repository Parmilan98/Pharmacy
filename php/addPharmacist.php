      ...
      <main>
        <div class="container">
            <div class="text-center py-3">
                <h4>Add New Pharmacist</h4>
            </div><hr />
            <div class="addcustomerForm" style="margin-left: 20%;">
            <!------------Add Pharmacist php code-------------->
                <?php
                    if(isset($_POST["submit"])){
                      $sql = "INSERT INTO pharmacist(PHANAME,PHANUMBER,PHAEMAIL,PHAADDRESS) 
                              VALUES ('{$_POST["phname"]}','{$_POST["phnumber"]}','{$_POST["phemail"]}','{$_POST["phaddress"]}')";
                      $db->query($sql);
                      echo "<p class='alert alert-success fw-bold w-75'><i class='fa-solid fa-circle-check'></i>&nbsp;Add Pharmacist details Successfully</p>";
                    }

                ?>
                <form action="addPharmacist.php" method="post" class="px-1 py-3">
                    <div class="row">
                        
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                <label for="phname" class="form-label">Pharmacist Name :</label>
                                <input type="text" name="phname" class="form-control w-75" id="phname" placeholder="Pharmacist Name" required>
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <input type="email" name="phemail" class="form-control w-75" id="phemail" placeholder="Email" required>
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="phnumber" class="form-control w-75" id="phnumber" placeholder="Contact Number" required>
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <textarea name="phaddress" class="form-control w-75" placeholder="Address" id="phaddress" required></textarea>

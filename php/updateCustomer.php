...
//   session_start();
  ...
  if(isset($_POST["submit"])){
        ...
        $sql = "UPDATE customer SET CUSNAME='$cname', CUSNUMBER=$cnumber, CUSNIC='$cnic', CUSADDRESS='$caddress' WHERE id=$id";
    ...
    <section class="home-section">
      ...
      <main>
        <div class="container">
            ...
            <?php
                $id = $_GET['id'];
                $sql = "SELECT CUSNAME, CUSNUMBER, CUSNIC, CUSADDRESS FROM customer WHERE id=$id";
                $result = mysqli_query($db, $sql);
                $numrow = mysqli_num_rows($result);
                if($numrow > 0){
                    $row = mysqli_fetch_assoc($result);
            ?>
                <form action="updateCustomer.php" method="post" class="px-1 py-3">
                    <div class="row"> 
                        <input type="hidden" name="id" value="<?=$id ?>">
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                <label for="cname" class="form-label">Customer Name :</label>
                                <input type="text" name="cname" class="form-control w-75" id="cname" placeholder="Name" required value="<?=$row['CUSNAME']?>" >
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="cnumber" class="form-control w-75" id="cnumber" placeholder="Contact Number" required value="<?=$row['CUSNUMBER']?>">
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="cnic" class="form-control w-75" id="cnic" placeholder="NIC" required value="<?=$row['CUSNIC']?>">
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <input name="caddress" class="form-control w-75" placeholder="Address" id="caddress" required value="<?=$row['CUSADDRESS']?>" >

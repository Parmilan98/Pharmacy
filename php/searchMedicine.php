...
<html lang="en">
  ...
  <div class="sidebar close">
    ...
    <section class="home-section">
      ...
      <div class="p-2">
        <main class="px-4">
          <h4 class="text-center py-3">Search Medicine</h4>
          ...
          {$sql = "SELECT * FROM medicine WHERE MEDNAME like '%{$_POST["search"]}%' or SNAME like '%{$_POST["search"]}%'";
            $result = $db->query($sql);
            if($result->num_rows>0)
            {
              echo "<table class='table table-striped table-hover'>
                      <tr>
                        <th class='text-light'>Medicine ID</th>
                        <th class='text-light'>Medicine Name</th>
                        <th class='text-light'>Supplier Name</th>
                        <th class='text-light'>Price</th>
                        <th class='text-light'>Quantity</th>
                        <th class='text-light'>Packing Details</th>
                      </tr>";
                      ...
                      {  
                        ...
                        echo "<td>{$row["MEDPACKING"]}</td>";
                        echo "</tr>";
                      }
              echo "</table>";
            }else{
              echo "<p class='alert alert-danger fw-bold w-50'>No searching Medicine Rocords Found.</p>";
            }
        }
        ?>
        <h4 class="text-center py-4">View all medicine Details</h4>
        <?php
            ...
            if($result->num_rows>0)
            {
              ...
              echo "<p>No Medicine Rocords Found.</p>";
            }

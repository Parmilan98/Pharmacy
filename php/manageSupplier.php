...
<html lang="en">
  ...
  <div class="sidebar close">
    ...
    <section class="home-section">
      ...
      <div class="p-2">
      <main class="px-4">
          <h4 class="text-center py-3">Manage Supplier Details</h4>
          <a href="addSupplier.php"> <button class="btn btn-primary my-3 float-end">+&nbsp;Add New Supplier</button></a>
          <?php
            ...
            if($result->num_rows>0)
            {
              echo "<table class='table table-striped table-hover'>
                      ...
                      { 
                        ...
                        echo "<td><a href='updateSupplier.php?id={$row["ID"]}' class='p-1'>
                                      <i class='fa-regular fa-pen-to-square'></i>
                                  </a>
                                  <a href='deleteSupplier.php?id={$row["ID"]}' style='color: red;' class='p-1'>

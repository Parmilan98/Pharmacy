      ...
      <main>
        <div class="container">
            <div class="text-center py-3">
                <h4><img src="../Images/addsupplier.png" alt="add supplier" class="mx-1" style="width: 30px; height: 30px;" />Add Supplier</h4>
            ...
            <!------------Add Supplier php code-------------->
                <?php
                    if(isset($_POST["submit"])){
                      $sql = "INSERT INTO supplier(NIC,SNAME,SEMAIL,SNUMBER,SADDRESS) 
                              VALUES ('{$_POST["snic"]}','{$_POST["sname"]}','{$_POST["semail"]}','{$_POST["snumber"]}','{$_POST["saddress"]}')";
                      $db->query($sql);
                      echo "<p class='alert alert-success fw-bold w-75'><i class='fa-solid fa-circle-check'></i>&nbsp;Add Supplier details Successfully</p>";
                    }

                ?>
                <form action="addSupplier.php" method="post" class="px-1 py-3">
                    <div class="row">
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                <label for="snic" class="form-label">NIC Number :</label>
                                <input type="text" name="snic" class="form-control w-75" id="snic" placeholder="NIC" required>
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="sname" class="form-control w-75" id="sname" placeholder="Name" required>
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <input type="email" name="semail" class="form-control w-75" id="semail" placeholder="Email" required>
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="snumber" class="form-control w-75" id="snumber" placeholder="Contact Number" required>
                        ...
                        <div class="form-group was-validated col-md-12 py-2">
                            <div class="mb-3">
                                ...
                                <textarea name="saddress" class="form-control w-75" placeholder="Address" id="saddress" required></textarea>
                                <div class="invalid-feedback">Please enter address</div>
                              </div>
                            <button style="width: 100px;" type="submit" id="submit" name="submit" class="btn btn-success">Add</button>  

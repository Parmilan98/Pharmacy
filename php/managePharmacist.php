...
<html lang="en">
  ...
  <div class="sidebar close">
    ...
    <section class="home-section">
      ...
      <div class="p-2">
      <main class="px-4">
          <h4 class="text-center py-4">Manage Pharmacist Details</h4>
          <a href="addPharmacist.php"> <button class="btn btn-primary my-3 float-end">+&nbsp;Add New Pharmacist</button></a>
          <?php
            ...
            if($result->num_rows>0)
            {
              echo "<table class='table table-striped table-hover table-responsive'>
                      ...
                      { 
                        ...
                        echo "<td>
                                <a href='updatePharmacist.php?id={$row["PAID"]}' class='p-1'>
                                      <i class='fa-regular fa-pen-to-square'></i>
                                </a>  
                             </td>";
                        echo "<td>
                                <a href='deletePharmacist.php?id={$row["PAID"]}' style='color: red;' class='p-1'>

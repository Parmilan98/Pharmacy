...
<html lang="en">
  ...
  <ul class="nav-links">
    ...
    <section class="home-section">
      ...
      <div class="p-2">
        <main class="px-4">
          <h4 class="text-center py-3">Search Supplier</h4>
          ...
          {
            $sql = "SELECT * FROM supplier WHERE SNAME like '%{$_POST["search"]}%' or SNUMBER like '%{$_POST["search"]}%' or SEMAIL like '%{$_POST["search"]}%'";
            $result = $db->query($sql);
        ...
        ?>
        <h5 class="text-center py-4">View all supplier Details</h5>
        <?php
